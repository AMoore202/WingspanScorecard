...
export default function Button({
  ...
  const baseStyles =
    "flex items-center justify-center rounded-button text-base font-medium pl-3 pr-3 pt-[6px] pb-[6px] focus-visible:outline-none focus-visible:ring-[3px] lg:focus-visible:ring-4 focus-visible:ring-border-focusBlue/75 disabled:pointer-events-none disabled:opacity-50 lg:text-xl";
