...
export async function createGame(formData:FormData) {
    const {
        ...
        p1_bird_points: safeParseInt(formData.get('p1birdpoints'),10),
        p1_bonus_cards: safeParseInt(formData.get('p1bonuscards'),10),
        p1_end_of_round_goals: safeParseInt(formData.get('p1eorgoals'),10),
        p1_eggs: safeParseInt(formData.get('p1eggs'),10),
        p1_food_on_cards: safeParseInt(formData.get('p1foodoncard'),10),
        p1_tucked_cards: safeParseInt(formData.get('p1tuckedcards'),10),
        p1_nectar: safeParseInt(formData.get('p1nectar'),10),
